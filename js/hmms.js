...
(function() {
  ...
  window.onload = function() {
    ...
    this.tables = 6;
    this.table = [];
    this.table[0] = new TimeTable('3ban.csv');
    this.table[1] = new TimeTable('4ban.csv');
    this.table[2] = new TimeTable('5ban.csv');
    this.table[3] = new TimeTable('6ban.csv');
    this.table[4] = new TimeTable('1ban.csv');
    this.table[5] = new TimeTable('2ban.csv');
    for (i = _i = 0; 0 <= tables ? _i < tables : _i > tables; i = 0 <= tables ? ++_i : --_i) {
